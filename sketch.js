...
diverImg = loadImage("assets/scubadiver.png")
...
pic1= loadImage("assets/pic1.png")
pic2= loadImage("assets/pic2.png")
pic3= loadImage("assets/pic3.png")
...
function draw() {
  ...
  if (gamestate == 1){
       ...
       image(pic1,120,height/2-100,400,300)
       image(pic2,550,height/2-100,400,300)
       image(pic3,980,height/2-100,400,300)
...
//  text ("lives: "+ lives,100,100)
  ...
  for (var i = 0; i < lives; i++) {
    image(bubbleImg, 30 + (i * 70),50,40,40);
    }
  ...
  swal(
    {
      ...
      imageUrl:"assets/scubadiver.png", 
      imageSize:"300x300",
      confirmButtonText: "Play Again"
    },
    function(isConfirm) {
